  ...
  const projects = [
    {
      title: "Casual Blog",
      description:
        "A blog website that lets you create an account, see other's posts and create your own! Using Javascript, React and CSS on the fron end, and Express, Node and MongoDB on the backend. I chose MongoDB for this database as it's more flexible with how the site will evolve over time using new features.",
